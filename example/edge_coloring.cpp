...
int main(int, char *[])
{
  using Graph = boost::adjacency_list<boost::vecS, boost::vecS, boost::undirectedS, boost::no_property, size_t, boost::no_property>;
  ...
  auto colors = edge_coloring(G, boost::get(boost::edge_bundle, G));
