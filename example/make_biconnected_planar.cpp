...
int main(int argc, char** argv)
{
  ...
  using component_storage_t = std::vector<boost::graph_traits<graph>::edges_size_type>;
  ...
  component_storage_t component_storage(boost::num_edges(g));
  component_map_t component(component_storage.begin(), boost::get(boost::edge_index, g));
  ...
  component_storage.resize(boost::num_edges(g));
  component = component_map_t(component_storage.begin(), boost::get(boost::edge_index,g));
