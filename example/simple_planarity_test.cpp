...
int main(int argc, char** argv)
{
  ...
  graph K_4(4);
  boost::add_edge(0, 1, K_4);
  boost::add_edge(0, 2, K_4);
  boost::add_edge(0, 3, K_4);
  boost::add_edge(1, 2, K_4);
  boost::add_edge(1, 3, K_4);
  boost::add_edge(2, 3, K_4);

  if (boost::boyer_myrvold_planarity_test(K_4))
  ...
  graph K_5(5);
  boost::add_edge(0, 1, K_5);
  boost::add_edge(0, 2, K_5);
  boost::add_edge(0, 3, K_5);
  boost::add_edge(0, 4, K_5);
  boost::add_edge(1, 2, K_5);
  boost::add_edge(1, 3, K_5);
  boost::add_edge(1, 4, K_5);
  boost::add_edge(2, 3, K_5);
  boost::add_edge(2, 4, K_5);

  // We've almost created a K_5 - it's missing one edge - so it should still
  // be planar at this point.

  if (boost::boyer_myrvold_planarity_test(K_5))
