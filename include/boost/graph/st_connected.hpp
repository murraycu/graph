             ...
             ColorMap color)
{
  ...
  BGL_FORALL_VERTICES_T(v, g, Graph)
    boost::put(color, v, ColorTraits::white());

  // Vertices found from the source are grey
  boost::put(color, s, ColorTraits::gray());

  // Vertices found from the target are greeen
  boost::put(color, t, ColorTraits::green());
  queue<Vertex> Q;
  Q.push(s);
  Q.push(t);
