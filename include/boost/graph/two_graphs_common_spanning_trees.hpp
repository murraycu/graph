  ...
  )
{
  ...
  BOOST_STATIC_ASSERT((std::is_same<order_value_type, edge_descriptor>::value));
  ...
  BOOST_STATIC_ASSERT((std::is_same<directed_category, undirected_tag>::value));
