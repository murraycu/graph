...
#undef BGL_DO_ONE_BUNDLE_TYPE
  ...
  struct lookup_one_property_internal<boost::property<Tag, T, Base>, Tag> {
    ...
    typedef T type;
    template <typename U>
    static typename enable_if<boost::is_same<prop, U>, T&>::type
    lookup(U& prop, const Tag&) {return prop.m_value;}
    template <typename U>
    static typename enable_if<boost::is_same<prop, U>, const T&>::type
  ...
  struct lookup_one_property_internal<boost::property<Tag, T, Base>, PropName>: lookup_one_property_internal<Base, PropName> {
    ...
    static typename lazy_enable_if<boost::is_same<PL, boost::property<Tag, T, Base> >,
                                   add_reference<typename base_type::type> >::type
  ...
  struct lookup_one_property<const T, Tag> {
    ...
    template <typename U>
    static typename lazy_enable_if<boost::is_same<T, U>,
...
namespace boost {
 ...
 namespace detail {
    ...
    struct is_no_property
        : mpl::bool_<boost::is_same<T, no_property>::value>
    { };
