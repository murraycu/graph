...
BOOST_AUTO_TEST_CASE(test0)
{
  ...
  BOOST_CHECK_EQUAL(parity0, boost::get(parities, 4));
  BOOST_CHECK_EQUAL(parity0, boost::get(parities, 5));
  const bool parity2 = boost::get(parities, 2);
  BOOST_CHECK_NE(parity0, parity2);
  BOOST_CHECK_EQUAL(parity2, boost::get(parities, 3));
  BOOST_CHECK_EQUAL(parity2, boost::get(parities, 6));
  BOOST_CHECK_EQUAL(parity2, boost::get(parities, 7));
}
...
BOOST_AUTO_TEST_CASE(test2)
{
  ...
  const bool parity5 = boost::get(parities, 5);
  BOOST_CHECK_NE(parity2, parity5);
  BOOST_CHECK_EQUAL(parity5, boost::get(parities, 3));
  BOOST_CHECK_EQUAL(parity5, boost::get(parities, 6));
  BOOST_CHECK_EQUAL(parity5, boost::get(parities, 1));
  BOOST_CHECK_EQUAL(parity5, boost::get(parities, 0));
}
...
BOOST_AUTO_TEST_CASE(test3)
{
  ...
  BOOST_CHECK_EQUAL(parity0, boost::get(parities, 2));
  BOOST_CHECK_EQUAL(parity0, boost::get(parities, 3));
  BOOST_CHECK_EQUAL(parity0, boost::get(parities, 4));
  BOOST_CHECK_EQUAL(parity0, boost::get(parities, 6));
  BOOST_CHECK_EQUAL(parity0, boost::get(parities, 7));
}
